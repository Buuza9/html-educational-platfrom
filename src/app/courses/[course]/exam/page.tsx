...
export default async function ExamPage({
  ...
  return (
    <div className="mx-auto w-full max-w-4xl">
      <header className="relative mb-8 overflow-hidden rounded-[var(--radius-lg)] bg-[linear-gradient(135deg,var(--c-main)_0%,var(--c-second)_100%)] px-6 py-9 sm:px-8 sm:py-10">
        <div
          aria-hidden="true"
        ...
        <div className="relative">
          ...
          <h1 className="mb-2.5 font-display text-[clamp(1.7rem,3.2vw,2.4rem)] font-bold tracking-tight text-[var(--c-fourth)]">
            الامتحان الشامل في {data.title}
          </h1>
          <p className="max-w-2xl text-base leading-[1.85] text-[var(--c-third)]">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <span className="flex items-center gap-2 rounded-[10px] border border-[rgba(240,236,229,0.18)] bg-[rgba(240,236,229,0.10)] px-4 py-2.5 text-[0.85rem] font-semibold text-[var(--c-fourth)]">
