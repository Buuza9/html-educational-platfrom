  ...
  return (
    <div className="min-h-screen bg-bg text-ink">
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        <section className="mb-12 border-b border-dashed border-line pb-12 text-start">
          ...
          <h1 className="mb-4 font-display text-[clamp(2rem,4.5vw,3.4rem)] font-bold leading-[1.18] tracking-[-0.015em] text-ink">
            تعلّم تطوير{" "}
          ...
          <p className="max-w-[680px] text-[1.05rem] leading-[1.85] text-ink-soft">
            دروس عربية مبسّطة وتمارين تفاعلية تأخذك من أساسيات HTML إلى تنسيق
            الصفحات باستخدام CSS خطوة بخطوة.
          </p>

          <div className="mt-8 grid max-w-[640px] grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              >
                <strong className="block font-display text-[1.7rem] font-bold leading-none text-accent">
                  {s.value}
                </strong>
